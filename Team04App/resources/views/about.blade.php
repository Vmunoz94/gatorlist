...
@section('jumbotronContent')
    <p class="lead text-center mb-1">Software Engineering class SFSU</h2>
    <p class="lead text-center mb-1">Spring 2019</h2>
    <p class="lead text-center mb-1">Section-01</h2>
    <p class="lead text-center mb-1">Team-04</h2>
@endSection
@section('body')
    <section class="mb-5">
    <div class="container">
